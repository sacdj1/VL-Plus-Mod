 ...
 * armor icon row to this element's position/scale.
 */
public class VanillaArmorHud extends HudElement {
    public static final HudElementInfo<VanillaArmorHud> INFO = new HudElementInfo<>(Hud.VANILLA_GROUP, "vanilla-armor", "Moves and scales the real armor icon row - reported not working correctly, under investigation.", VanillaArmorHud::new);
